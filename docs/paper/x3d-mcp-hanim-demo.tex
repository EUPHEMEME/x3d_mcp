...
artifact, we treat the human--AI pair as collaborators: the human supplies intent,
...
tool throughout this work---procedural generation, schema and semantic validation,
render automation, and drafting---under the human author's direction. In keeping
with the ACM Policy on Authorship, the generative AI is not credited as an author:
the human author conceived the work, made every substantive decision, and is
