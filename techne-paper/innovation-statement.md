...
on BAML, carries 43 passing tests, and is verified live end-to-end against the
...
`x3d_mcp` (two open upstream PRs). *AI integration:* the LLM is a fast, accountable
...
`techne`, `potter-creek-cave`) · upstream PRs #9, #10.
